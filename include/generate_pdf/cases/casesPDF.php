...
class MYPDF extends TCPDF {
    ...
    public function ColoredTable($header,$data) {
        ...
        foreach($data as $row) {
            ...
            $this->Cell($w[1], 6, $row["caseType"], 'LR', 0, 'L', $fill);
            // $this->MultiCell($w[2], 6, $row["citation"], 'LR', 0, 'L', $fill);
            $this->Cell($w[3], 6, $row["courtType"], 'LR', 0, 'L', $fill);
...
$header = array('caseNumber', 'Case Type', 'court Type', 'Created Date');
