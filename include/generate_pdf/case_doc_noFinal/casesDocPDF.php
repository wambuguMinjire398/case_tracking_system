...
class MYPDF extends TCPDF {
    ...
    public function LoadData() {
        // Read file lines
        include 'connect.php';
        $select = "SELECT * FROM adddoc WHERE finalDoc IS NULL";
    ...
    public function ColoredTable($header,$data) {
        ...
        foreach($data as $row) {
            ...
            $this->Cell($w[2], 6, $row["citation"], 'LR', 0, 'L', $fill);
            $this->Cell($w[3], 6, $row["activityDate"], 'LR', 0, 'L', $fill);
...
$header = array('id', 'Case Number', 'Citation', 'Activity Date');
