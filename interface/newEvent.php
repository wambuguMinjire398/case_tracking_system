...
<div class="dashboard_content_main">
            ...
            <h1 class="section_header"><i class="fa fa-plus"></i>Add Upcoming Event</h1>
                <form action="../include/add_event/newEvent/newEvent.inc.php" 
                method="POST" 
...
<form action="newEvent .php" method="POST">
  ...
  <!-- trial table -->
  <h1 class="section_header"><i class="fa fa-plus"></i>Upcoming Events</h1>
...
$sql = "SELECT * FROM class_list WHERE caseNumber = '$search' ORDER BY caseNumber";
$result = mysqli_query($conn, $sql);
  ...
  while ($row = $result->fetch_assoc()) {
      ...
      <tr>
          ...
          <td>
              <!-- decline -->
              <a class='btn btn-danger' name='decline' value='decline' href='../include/add_event/newEvent/eventDelete.php?delete=<?php echo $row['id']; ?>'>delete </a>
          </td>
      </tr>
  <?php
  }
